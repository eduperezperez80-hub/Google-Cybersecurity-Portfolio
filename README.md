...
* **[Análisis de Tráfico con Tcpdump e Incidentes Web](./04-Analisis-Trafico-Tcpdump):** Identificación de vectores de ataque mediante registros de red, análisis de redirecciones de dominios y propuestas de mitigación contra fuerza bruta.
